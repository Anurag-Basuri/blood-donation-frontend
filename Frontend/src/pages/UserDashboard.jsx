...
const UserDashboard = () => {
	...
	const user = userData
		? {
				...
				nextDonation: userData.lastDonation
					? new Date(
			...
			<div className="lg:col-span-2 space-y-6">
				...
				>
					...
					<div className="flex items-center justify-between">
						<div>
							<p style={{ color: colors.text }}>{user.lastDonation.toDateString()}</p>
					...
					<div className="p-4">
						...
						<nav className="space-y-2">
							...
							<NavigationItem
								...
								label="Find Camps"
								notifications={upcomingCamps.filter(c => !c.registered).length}
							/>
							<NavigationItem
					...
					<div className="flex justify-between items-center mb-8">
						...
						<div className="flex items-center space-x-2">
							<div className="h-8 w-8 rounded-full bg-red-100 flex items-center justify-center">
								<UserIcon className="h-5 w-5" style={{ color: colors.primary }} />
							</div>
							{sidebarOpen && user && (

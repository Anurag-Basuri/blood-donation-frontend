		...
		<div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
			...
			<div className="relative z-10 min-h-screen flex items-center justify-center p-4">
				<div className="w-full max-w-7xl grid lg:grid-cols-2 gap-12 items-stretch">
					...
					{/* Right - Login Form (Scrollable) */}
					<div className="w-full lg:max-h-screen overflow-y-auto flex items-center justify-center">
						<div className="relative bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl overflow-hidden w-full max-w-lg my-8">
							{/* Form Header */}

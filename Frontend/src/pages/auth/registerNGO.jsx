    ...
    <motion.div className="space-y-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <form onSubmit={submit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          />
          <Input label="Full Address" value={local.address} onChange={handle('address')} />
          <Input
            label="Registration Number"
            value={local.regNumber}
            onChange={handle('regNumber')}
          />
          <Input label="Affiliation" value={local.affiliation} onChange={handle('affiliation')} />
          <Input
          ...
          />
          <Input label="License Number" value={local.license} onChange={handle('license')} />
          <Input
            label="Password"

			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex items-center justify-between h-16">
					...
					<div className="flex-shrink-0 flex items-center">
						...
						<span className="ml-2 text-xl font-bold text-red-800">BloodHero</span>
					</div>
			...
			<section className="relative pt-20 h-screen overflow-hidden">
				...
				<div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-6">
					...
					>
						...
						>
							Join our movement to save lives through blood donation. Your single
							donation can help up to 3 people.
						</motion.p>
					...
					<div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
						...
						>
							...
							<p className="text-xl text-gray-700 leading-relaxed">
								...
								we've revolutionized blood donation through our digital platform
								that connects donors with recipients in real-time.
							</p>

...
class AiController {
    ...
    static findDonorMatches = asyncHandler(async (req, res) => {
        const { bloodType, location, urgency, quantity, specialRequirements } =
            req.body;
        ...
        return res
            ...
            .json(
                new ApiResponse(
                    200,
                    { matches },
                    "Donor matches found successfully"
                )
            );
    });
    ...
    static optimizeEmergencyResponse = asyncHandler(async (req, res) => {
        ...
        return res
            .status(200)
            .json(
                new ApiResponse(200, response, "Emergency response optimized")
            );
    });
        ...
        return res
            ...
            .json(
                new ApiResponse(
                    200,
                    analysis,
                    "Donor retention analysis completed"
                )
            );
    });

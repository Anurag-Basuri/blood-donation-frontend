...
const FACILITIES = [
    "Free Health Checkup", "Refreshments", "Donation Certificates", "Transport",
    "Blood Testing", "Blood Storage", "Counseling", "Emergency Response",
    "Home Collection", "Mobile Collection Unit", "Platelet Donation"
];

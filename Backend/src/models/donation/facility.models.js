...
const DonationCenter = Facility.discriminator(FACILITY_TYPE.CENTER, new mongoose.Schema({}));
...
export { Facility, DonationCenter, DonationCamp, FACILITY_TYPE, FACILITY_STATUS };
